        ...
        <div className="bg-cyan-300/20 rounded-xl p-8 max-w-4xl mx-auto border border-cyan-700 shadow-md hover:shadow-xl transition-shadow">
          ...
          <ul className="space-y-4 mb-6">
            <li className="flex items-center space-x-3">
              ...
              <span className="text-gray-700">Work with an experienced Farm to School Coach throughout the program</span>
            </li>
            <li className="flex items-center space-x-3">
              <Calendar className="w-5 h-5 text-cyan-700 flex-shrink-0" />
              <span className="text-gray-700">Attend a 3-day retreat in Summer 2025 to action plan and build relationships</span>
            </li>
            <li className="flex items-center space-x-3">
              <Clock className="w-5 h-5 text-cyan-700 flex-shrink-0" />
              <span className="text-gray-700">Receive ongoing technical assistance through monthly meetings during 2025-2026</span>
            </li>
          </ul>
